...
3. Если запускаете на физическом устройстве, настройте подпись (см. `DEVICE_SIGNING_AND_LOGS.md`) — выберите свою команду в Signing & Capabilities и доверьте сертификат на устройстве.

4. **ВАЖНО: Добавьте index.html в проект**
...
6. Нажмите ⌘+R для запуска приложения
